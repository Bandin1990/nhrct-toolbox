...
async function generate(query, evidence) {
  ...
  const finalPrompt = `${prompt}\n\nรูปแบบคำตอบที่ต้องใช้:\n1. เริ่มด้วยหัวข้อ “คำตอบโดยสรุป”\n2. แยกหลักฐานและการอธิบายเป็น 3 ส่วนให้ชัดเจน: “ข้อกฎหมาย/ระเบียบ/ประกาศ/คำสั่ง” สำหรับเอกสารประเภทกฎหมาย, “แนวทางจากคู่มือปฏิบัติงาน” สำหรับคู่มือ, และ “ตัวอย่างแนวปฏิบัติ/บทเรียน” สำหรับบทเรียนหรือแนวทางการทำงาน\n3. ห้ามเรียกคู่มือหรือบทเรียนว่าเป็นข้อกฎหมาย และห้ามยกระดับตัวอย่างการทำงานให้เป็นข้อบังคับ\n4. หากส่วนใดไม่มีหลักฐาน ให้เขียนว่า “ไม่พบหลักฐานในเอกสารส่วนนี้” ห้ามเติมข้อมูล\n5. หากเป็นเรื่องขั้นตอน ให้เรียงเป็นข้อ 1, 2, 3 ตามหลักฐาน\n6. หากเปรียบเทียบเงื่อนไขหรือเอกสาร ให้ใช้ตาราง Markdown ที่อ่านง่าย\n7. แยกหัวข้อ “ข้อควรระวัง” เมื่อหลักฐานมีข้อจำกัด\n8. ปิดท้ายด้วย “เอกสารอ้างอิง” และใส่ [1], [2] ให้ตรงกับหลักฐานเท่านั้น โดยใช้ชื่อเอกสาร ไม่ใช้ชื่อไฟล์\n9. ใช้เลขอารบิก 0-9 ทุกกรณี และห้ามใช้เครื่องหมาย Markdown หนา เช่น ** หรือ __`;
